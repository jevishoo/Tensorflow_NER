...
def get_labels():
    # return ["M-CONT", "B-CONT", "E-CONT", "S-CONT",
    #         "M-EDU", "B-EDU", "E-EDU", "S-EDU",
    #         "M-LOC", "B-LOC", "E-LOC", "S-LOC",
    #         "M-NAME", "B-NAME", "E-NAME", "S-NAME",
    #         "M-ORG", "B-ORG", "E-ORG", "S-ORG",
    #         "M-PRO", "B-PRO", "E-PRO", "S-PRO",
    #         "M-RACE", "B-RACE", "E-RACE", "S-RACE",
    #         "M-TITLE", "B-TITLE", "E-TITLE", "S-TITLE",
    #         "O", "X", "[CLS]", "[SEP]", '']
    return ['ELE-I', 'ELE-B', 'ELE-E', 'ELE-S',
            'IND-I', 'IND-B', 'IND-E', 'IND-S',
            'CON-I', 'CON-B', 'CON-E', 'CON-S',
            'SIT-I', 'SIT-B', 'SIT-E', 'SIT-S',
            "O", "X", "[CLS]", "[SEP]", ""]
...
if __name__ == '__main__':
    ...
    dev_iter = DataIterator(config.batch_size, data_file=config.new_data_process_quarter_final + 'train.txt',
                            use_bert=True, seq_length=config.sequence_length, tokenizer=tokenizer)
    #
    ...
    # dev_iter = DataIterator(config.batch_size, data_file=config.new_data_process_quarter_final + 'test.txt',
